...
- `BLAST_LOGO_PRIMARY_PATH`: path for the default BLAST logo asset applied after generation
- `BLAST_LOGO_LIGHT_PATH`: path for the light BLAST logo asset applied automatically on dark footers
