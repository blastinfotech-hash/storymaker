...
OPENAI_IMAGE_SIZE = os.getenv('OPENAI_IMAGE_SIZE', '1024x1792')
OPENAI_REQUEST_TIMEOUT = float(os.getenv('OPENAI_REQUEST_TIMEOUT', '90'))
BLAST_LOGO_PRIMARY_PATH = os.getenv('BLAST_LOGO_PRIMARY_PATH', str(BASE_DIR / 'BLAST-01.png'))
BLAST_LOGO_LIGHT_PATH = os.getenv('BLAST_LOGO_LIGHT_PATH', str(BASE_DIR / 'BLAST-02.png'))
